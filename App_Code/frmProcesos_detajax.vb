...
Public Class frmProcesos_detajax
...
Dim auxDA As New SqlDataAdapter("SELECT  DISTINCT DOC_PRO.dsc FROM DOC_PRO   WHERE (dsc LIKE @prefixText) AND (DOC_PRO.baja = 0 OR DOC_PRO.baja  IS NULL)",auxConn)
