...
Public Class frmGrupos_detajax
Inherits System.Web.Services.WebService
<ScriptMethod()> _ 
<WebMethod()> _ 
Public Function editctrl000011_Get (ByVal prefixText As String, ByVal count As Integer) As String()
Dim auxList As New List(Of String)
Dim auxConn As  SqlConnection=gConn_open
Dim auxDA As New SqlDataAdapter("SELECT  DISTINCT Q_SECPGRP.grpdsc FROM Q_SECPGRP   WHERE grpdsc LIKE @prefixText",auxConn)
...
<ScriptMethod()> _ 
<WebMethod()> _ 
Public Function insctrl000011_Get (ByVal prefixText As String, ByVal count As Integer) As String()
Dim auxList As New List(Of String)
Dim auxConn As  SqlConnection=gConn_open
Dim auxDA As New SqlDataAdapter("SELECT  DISTINCT Q_SECPGRP.grpdsc FROM Q_SECPGRP   WHERE grpdsc LIKE @prefixText",auxConn)
auxDA.SelectCommand.Parameters.Add(New SqlParameter("@prefixText", SqlDbType.Text)).Value ="%" & prefixText & "%"
