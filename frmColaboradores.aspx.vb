...
Protected Sub ctrl000020delete_Click (ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs)
ctrl000020type.Value=-1
ctrl000020.Value=-1
ctrl000020view.Visible=False
ctrl000020delete.Visible=False

End Sub
Protected Sub ctrl000020delete_DataBinding(ByVal sender As Object, ByVal e As System.EventArgs)
...
End Sub
Protected Sub cmdctrl000020showpanel_Click (ByVal sender As Object, ByVal e As System.EventArgs)
objexplorer_Show(CType(sender.parent.FindControl("ctrl000020"),HiddenField).UniqueID,CType(sender.parent.FindControl("ctrl000020view"),LinkButton).UniqueID,CType(sender.parent.FindControl("ctrl000020type"),HiddenField).UniqueID,"10","10",CType(sender.parent.FindControl("ctrl000020delete"),ImageButton).UniqueID)
End Sub
...
Protected Sub dsctrl000020_Init(ByVal sender As Object,ByVal e As System.EventArgs)
sender.ConnectionString=Session("connectionstringname")
End Sub
Protected Sub dsctrl000020_Deleted(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.SqlDataSourceStatusEventArgs)
...
End Sub
Protected Sub dsctrl000020_Inserted(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.SqlDataSourceStatusEventArgs)
If e.Exception IsNot Nothing Then
...
End Sub
Protected Sub dsctrl000020_Selected(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.SqlDataSourceStatusEventArgs)
If e.Exception IsNot Nothing Then
...
End Sub
Protected Sub dsctrl000020_Updated(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.SqlDataSourceStatusEventArgs)
If e.Exception IsNot Nothing Then
...
Protected Sub ctrl000017_Click (ByVal sender As Object, ByVal e As System.EventArgs)
ctrl000022.DataBind()

End Sub

Protected Sub ctrl000016_Click (ByVal sender As Object, ByVal e As System.EventArgs)
             CType(sender.parent.FindControl("ctrl000019"),TextBox).Text=""
          CType(sender.parent.FindControl("ctrl000020"),HiddenField).Value="-1"
          CType(sender.parent.FindControl("ctrl000020view"),LinkButton).Text=""
          CType(sender.parent.FindControl("ctrl000020delete"),ImageButton).Visible=False

End Sub

Protected Sub ctrl000015_Load(ByVal sender As Object, ByVal e As System.EventArgs)
sender.Visible=m_PermFormNew

End Sub

Protected Sub ctrl000022colitem1view_DataBinding(ByVal sender As Object, ByVal e As System.EventArgs)
...
Protected Sub ctrl000022colitem2view_DataBinding(ByVal sender As Object, ByVal e As System.EventArgs)
...
End Sub
Protected Sub ctrl000022colitem2_Databound(ByVal sender As Object, ByVal e As System.EventArgs)
If IsDBNull(Eval("undcod")) Then
...
Protected Sub ctrl000022colitem3_Databound(ByVal sender As Object, ByVal e As System.EventArgs)
CType(sender,Label).Text=Replace(Eval("mail").ToString,Chr(10),"<br />")

End Sub

Protected Sub ctrl000022colitem4_Databound(ByVal sender As Object, ByVal e As System.EventArgs)
CType(sender,Label).Text=Replace(Eval("empusername").ToString,Chr(10),"<br />")

End Sub

Protected Sub cmdctrl000022edit_DataBinding(ByVal sender As Object, ByVal e As System.EventArgs)
sender.Visible=m_PermFormedit
End Sub

Protected Sub cmdctrl000022delete_DataBinding(ByVal sender As Object, ByVal e As System.EventArgs)
sender.Visible=m_PermFormDelete

End Sub

Protected Sub cmdctrl000022copy_DataBinding(ByVal sender As Object, ByVal e As System.EventArgs)
sender.Visible=m_PermFormNew

End Sub

Protected Sub ctrl000022_ItemDeleted(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewCommandEventArgs)

End Sub
Protected Sub ctrl000022_ItemInserted(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewCommandEventArgs)

End Sub
Protected Sub ctrl000022_ItemSelected(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewCommandEventArgs)

End Sub
Protected Sub ctrl000022_ItemUpdated(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewCommandEventArgs)

End Sub
Protected Sub ctrl000022_RowCommand(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewCommandEventArgs)
Select Case e.CommandName.ToUpper()
End Select

End Sub
Protected Sub ctrl000022_RowCreated(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewRowEventArgs)
...
Protected Sub dsctrl000022_Init(ByVal sender As Object,ByVal e As System.EventArgs)
sender.ConnectionString=Session("connectionstringname")
End Sub
Protected Sub dsctrl000022_Deleted(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.SqlDataSourceStatusEventArgs)
If e.Exception IsNot Nothing Then
  lblerror.Text &="//Error borrando datos (" & e.Exception.Message & ")"
...
End Sub
Protected Sub dsctrl000022_Inserted(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.SqlDataSourceStatusEventArgs)
If e.Exception IsNot Nothing Then
  lblerror.Text &="//Error insertando datos (" & e.Exception.Message & ")"
...
End Sub
Protected Sub dsctrl000022_Selected(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.SqlDataSourceStatusEventArgs)
If e.Exception IsNot Nothing Then
  lblerror.Text &="//Error buscando datos (" & e.Exception.Message & ")"
...
End Sub
Protected Sub dsctrl000022_Selecting(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.SqlDataSourceSelectingEventArgs)
...
End Sub
Protected Sub dsctrl000022_Updated(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.SqlDataSourceStatusEventArgs)
If e.Exception IsNot Nothing Then
  lblerror.Text &="//Error actualizando datos (" & e.Exception.Message & ")"
...
Protected Sub frmColaboradores_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
