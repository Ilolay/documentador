<%@ Page Language="VB" CodeFile="frmtimeout_det.aspx.vb" MasterPageFile="general.master" AutoEventWireup="True" Inherits="frmtimeout_det" Title="Sesión expirada" %>
...
<td  style="text-align:left;" colspan="1" ><span class="form-title">Sesión expirada</span> |<asp:Label  runat="server" ID="lblsubtitle" CssClass="form-subtitle" />
</td></tr>
</table>
</td></tr>
