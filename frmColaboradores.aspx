<%@ Page Language="VB" CodeFile="frmColaboradores.aspx.vb" MasterPageFile="general.master" AutoEventWireup="True" Inherits="frmColaboradores" Title="Colaboradores" %>
...
<td  style="text-align:left;" colspan="1" ><span class="form-title">Colaboradores</span></td></tr>
</table>
</td></tr>
...
							<tr><td  class="search-item-title" style="vertical-align:top;width:15%" colspan="1" >								Nombre y apellido								</td>								<td  class="search-table" style="vertical-align:top;width:35%" colspan="1" >								<asp:TextBox  runat="server" ID="ctrl000019" CssClass="form-control" Width="280px" MaxLength="30" Tooltip="Campo28[]" />
<asp:CompareValidator  runat="server" ID="vcdvalctrl000019" SetFocusOnError="true" CssClass="error" ControltoValidate="ctrl000019" Display="Dynamic" Text="Ingrese un texto" ErrorMessage="Nombre y apellido:Ingrese un texto" Type="String" Operator="DataTypeCheck" ValidationGroup="vg" />
<asp:RegularExpressionValidator  runat="server" ID="vrgvalctrl000019" SetFocusOnError="true" CssClass="error" Display="Dynamic" ControltoValidate="ctrl000019" ValidationExpression="[\w\s-+/*^()!|°$%&=-_,:;.ñÑ~áéíóúÁÉÍÓÚ#}{¿]{0,30}" Text="No mayor a 30 caracteres. Deben ser letras o numeros." ErrorMessage="Nombre y apellido:No mayor a 30 caracteres. Deben ser letras o numeros." ValidationGroup="vg" />
<ajaxkit:ValidatorCalloutExtender  runat="server" ID="ajaxvrgctrl000019" TargetControlID="vrgvalctrl000019" />
								</td><td  class="search-item-title" style="vertical-align:top;width:15%" colspan="1" >							Unidad							</td>							<td  class="search-table" style="vertical-align:top;width:35%" colspan="1" >							<asp:UpdatePanel  ID="updupdpnlupdctrl000020fs" runat="server" UpdateMode="Conditional" ChildrenAsTriggers="True" >
<Triggers>
  <asp:AsyncPostBackTrigger  ControlID="ctrl000020delete" EventName="Click" />
</Triggers>
<ContentTemplate>
<asp:UpdatePanel  ID="updupdctrl000020fs" runat="server" UpdateMode="Conditional" ChildrenAsTriggers="True" >
<ContentTemplate>
<asp:Button  runat="server" ID="cmdctrl000020showpanel" Text="..." CssClass="boton-acciones" CausesValidation="False" OnClick="cmdctrl000020showpanel_Click" />

<asp:ImageButton runat="server" ID="ctrl000020delete" ImageURL="~/imagenes/actdel.png" Width="16" Height="16" Tooltip="Quitar Unidad" Visible="False" OnClick="ctrl000020delete_Click" OnDataBinding="ctrl000020delete_DataBinding" CausesValidation="False" />
<asp:LinkButton runat="server" ID="ctrl000020view" CssClass="boton-acciones-subbutton" CausesValidation="False" />
<asp:HiddenField  runat="server" ID="ctrl000020type"/>
<asp:HiddenField  runat="server" ID="ctrl000020" onLoad="ctrl000020_Load"/>
</ContentTemplate>
</asp:UpdatePanel>
<asp:UpdateProgress  runat="server" AssociatedUpdatePanelID="updupdctrl000020fs" >
...
<asp:UpdateProgress  runat="server" AssociatedUpdatePanelID="updupdpnlupdctrl000020fs" >
<ProgressTemplate><span  class="ajaxupd" ><div style="position:absolute;top:2px;left:50%; border-color:#333333; border:1; border-style:solid; background-color:#FFFFFF;padding:3px;"><image src="imagenes/ajaxupdate.gif" border=0 />Actualizando</div></span></ProgressTemplate>
</asp:UpdateProgress>
							</td>						</tr>						<asp:SqlDataSource  runat="server" ID="dsctrl000020" CancelSelectOnNullParameter="False" onInit="dsctrl000020_Init" SelectCommandType="Text"
 SelectCommand="SELECT UND.dsc,UND.cod FROM UND   WHERE (UND.baja = 0 OR UND.baja  IS NULL) ORDER BY UND.orden" onselected="dsctrl000020_Selected" >
<SelectParameters>
</SelectParameters>
</asp:SqlDataSource>
...
<tr>
<td  class="search-title" colspan="5" >								<asp:Button  runat="server" ID="ctrl000017" Text="Buscar" CssClass="boton-acciones" CausesValidation="True" OnClick="ctrl000017_Click" ValidationGroup="vg" />							<asp:Button  runat="server" ID="ctrl000016" Text="Limpiar filtros" CssClass="boton-acciones" CausesValidation="True" OnClick="ctrl000016_Click" ValidationGroup="vg" />						<asp:Button  runat="server" ID="ctrl000015" Text="Nuevo" CssClass="boton-acciones" CausesValidation="False" OnLoad="ctrl000015_Load" PostBackURL="frmColaboradores_det.aspx?_mode_=1&_closea_=0" />					<asp:Button  runat="server" ID="ctrl000014" Text="Refrescar" CssClass="boton-acciones" CausesValidation="True" ValidationGroup="vg" />		</td></tr>
</table>
<!-- End -->
</ContentTemplate>
</asp:UpdatePanel>
...
<Triggers>
  <asp:AsyncPostBackTrigger  ControlID="ctrl000017" EventName="Click" />
  <asp:AsyncPostBackTrigger  ControlID="ctrl000016" EventName="Click" />
  <asp:AsyncPostBackTrigger  ControlID="ctrl000014" EventName="Click" />
</Triggers>
<ContentTemplate>
...
					<tr>						<td  class="search-table" style="vertical-align:top;" colspan="4" >						<asp:UpdatePanel  ID="updupdpnlctrl000022" runat="server" UpdateMode="Conditional" ChildrenAsTriggers="True" >
<Triggers>
  <asp:AsyncPostBackTrigger  ControlID="ctrl000017" EventName="Click" />
  <asp:AsyncPostBackTrigger  ControlID="ctrl000016" EventName="Click" />
</Triggers>
<ContentTemplate>
<asp:UpdatePanel  ID="updupdctrl000022" runat="server" UpdateMode="Conditional" ChildrenAsTriggers="True" >
<Triggers>
  <asp:AsyncPostBackTrigger  ControlID="ctrl000022" EventName="PageIndexChanging" />
</Triggers>
<ContentTemplate>

<asp:GridView  runat="server" ID="ctrl000022" AllowPaging="True" AllowSorting="True" AutoGenerateColumns="False" CssClass="form-control" PageSize="50"
 GridLines="None" ShowHeader="True" ShowFooter="True" Width="100%" UseAccessibleHeader="False" DataKeyNames="cod" CellPadding="2" DataSourceID="dsctrl000022" onRowCreated="ctrl000022_RowCreated" >
...
<ItemTemplate>
<asp:Image  runat="server" ID="rowctrl000022imageimg" Width="12px" GenerateEmptyAlternateText="True" ImageURL="imagenes/icon00000009.png" BorderWidth="0" AlternateText="Imagen no disp." />
</ItemTemplate>
</asp:TemplateField>
<asp:TemplateField   AccessibleHeaderText="Nombre y apellido" HeaderText="Nombre y apellido" SortExpression="dsc" ItemStyle-CssClass="tabla-celda" HeaderStyle-CssClass="tabla-titulo" FooterStyle-CssClass="tabla-celda">
<ItemStyle  HorizontalAlign="Left" CssClass="searchresult-table-cell" />
<ItemTemplate>
<asp:LinkButton runat="server" ID="ctrl000022colitem1view" Text='<%# Eval("dsc") %>' CssClass="form-control-read" OnDataBinding="ctrl000022colitem1view_DataBinding" CausesValidation="False" OnClientClick='<%# "javascript:if (window.showModalDialog) {window.showModalDialog(" & chr(39) & "frmColaboradores_det.aspx?_mode_=0&_closea_=1&isDlg=1&param1=" & Eval("cod") & "&timestamp=" & chr(39) & " + new Date().getTime() + " & chr(39) & "" & chr(39) & ", " & chr(39) & "" & chr(39) & ", " & chr(39) & "menubar=no;resizable=yes;toolbar=no;status=no;center=yes;dialogWidth=750px;dialogHeight=570px;" & chr(39) & ");} else {window.open(" & chr(39) & "frmColaboradores_det.aspx?_mode_=0&_closea_=1&isDlg=1&param1=" & Eval("cod") & "&timestamp=" & chr(39) & " + new Date().getTime() + " & chr(39) & "" & chr(39) & ", " & chr(39) & "" & chr(39) & ", " & chr(39) & "modal=yes;directories=no;menubar=no;resizable=yes;toolbar=no;status=no;center=yes;dialogWidth=750px;dialogHeight=570px;" & chr(39) & ");};return false;" %>' PostBackUrl='<%# "javascript:if (window.showModalDialog) {window.showModalDialog(" & chr(39) & "frmColaboradores_det.aspx?_mode_=0&_closea_=1&isDlg=1&param1=" & Eval("cod") & "&timestamp=" & chr(39) & " + new Date().getTime() + " & chr(39) & "" & chr(39) & ", " & chr(39) & "" & chr(39) & ", " & chr(39) & "menubar=no;resizable=yes;toolbar=no;status=no;center=yes;dialogWidth=750px;dialogHeight=570px;" & chr(39) & ");} else {window.open(" & chr(39) & "frmColaboradores_det.aspx?_mode_=0&_closea_=1&isDlg=1&param1=" & Eval("cod") & "&timestamp=" & chr(39) & " + new Date().getTime() + " & chr(39) & "" & chr(39) & ", " & chr(39) & "" & chr(39) & ", " & chr(39) & "modal=yes;directories=no;menubar=no;resizable=yes;toolbar=no;status=no;center=yes;dialogWidth=750px;dialogHeight=570px;" & chr(39) & ");};return false;" %>' />
</ItemTemplate>
</asp:TemplateField>
<asp:TemplateField   AccessibleHeaderText="Unidad" HeaderText="Unidad" SortExpression="undcod" ItemStyle-CssClass="tabla-celda" HeaderStyle-CssClass="tabla-titulo" FooterStyle-CssClass="tabla-celda">
<ItemStyle  HorizontalAlign="Left" CssClass="searchresult-table-cell" />
<ItemTemplate>
<asp:LinkButton runat="server" ID="ctrl000022colitem2view" Text='<%# Eval("undcoddsc") %>' CssClass="form-control-read" OnDataBinding="ctrl000022colitem2view_DataBinding" CausesValidation="False" OnClientClick='<%# "javascript:if (window.showModalDialog) {window.showModalDialog(" & chr(39) & "frmUnidades_det.aspx?_mode_=0&_closea_=1&isDlg=1&param1=" & Eval("undcod") & "&timestamp=" & chr(39) & " + new Date().getTime() + " & chr(39) & "" & chr(39) & ", " & chr(39) & "" & chr(39) & ", " & chr(39) & "menubar=no;resizable=yes;toolbar=no;status=no;center=yes;dialogWidth=750px;dialogHeight=570px;" & chr(39) & ");} else {window.open(" & chr(39) & "frmUnidades_det.aspx?_mode_=0&_closea_=1&isDlg=1&param1=" & Eval("undcod") & "&timestamp=" & chr(39) & " + new Date().getTime() + " & chr(39) & "" & chr(39) & ", " & chr(39) & "" & chr(39) & ", " & chr(39) & "modal=yes;directories=no;menubar=no;resizable=yes;toolbar=no;status=no;center=yes;dialogWidth=750px;dialogHeight=570px;" & chr(39) & ");};return false;" %>' PostBackUrl='<%# "javascript:if (window.showModalDialog) {window.showModalDialog(" & chr(39) & "frmUnidades_det.aspx?_mode_=0&_closea_=1&isDlg=1&param1=" & Eval("undcod") & "&timestamp=" & chr(39) & " + new Date().getTime() + " & chr(39) & "" & chr(39) & ", " & chr(39) & "" & chr(39) & ", " & chr(39) & "menubar=no;resizable=yes;toolbar=no;status=no;center=yes;dialogWidth=750px;dialogHeight=570px;" & chr(39) & ");} else {window.open(" & chr(39) & "frmUnidades_det.aspx?_mode_=0&_closea_=1&isDlg=1&param1=" & Eval("undcod") & "&timestamp=" & chr(39) & " + new Date().getTime() + " & chr(39) & "" & chr(39) & ", " & chr(39) & "" & chr(39) & ", " & chr(39) & "modal=yes;directories=no;menubar=no;resizable=yes;toolbar=no;status=no;center=yes;dialogWidth=750px;dialogHeight=570px;" & chr(39) & ");};return false;" %>' />
<asp:HiddenField  runat="server" ID="ctrl000022colitem2type"/>
<asp:HiddenField  runat="server" ID="ctrl000022colitem2" OnDataBinding="ctrl000022colitem2_DataBound"/>
</ItemTemplate>
</asp:TemplateField>
<asp:TemplateField   AccessibleHeaderText="Mail" HeaderText="Mail" SortExpression="mail" ItemStyle-CssClass="tabla-celda" HeaderStyle-CssClass="tabla-titulo" FooterStyle-CssClass="tabla-celda">
<ItemStyle  HorizontalAlign="Left" CssClass="searchresult-table-cell" />
<ItemTemplate>
<asp:Label  runat="server" ID="ctrl000022colitem3" width="100%" OnDataBinding="ctrl000022colitem3_Databound" /></ItemTemplate>
</asp:TemplateField>
<asp:TemplateField   AccessibleHeaderText="Usuario de red" HeaderText="Usuario de red" SortExpression="empusername" ItemStyle-CssClass="tabla-celda" HeaderStyle-CssClass="tabla-titulo" FooterStyle-CssClass="tabla-celda">
<ItemStyle  HorizontalAlign="Left" CssClass="searchresult-table-cell" />
<ItemTemplate>
<asp:Label  runat="server" ID="ctrl000022colitem4" width="100%" OnDataBinding="ctrl000022colitem4_Databound" /></ItemTemplate>
</asp:TemplateField>
<asp:HyperLinkField  HeaderText="Ver" DataNavigateUrlFields="cod" DataNavigateUrlFormatString="frmColaboradores_det.aspx?_mode_=0&_closea_=0&param1={0}" ItemStyle-HorizontalAlign="Center" ItemStyle-Width="16" Text="&lt;img src=./imagenes/actview.png border=0&gt alt='Ver' width='16' ;" >
...
<ItemTemplate>
<asp:ImageButton runat="server" ID="cmdctrl000022edit" ImageURL="./imagenes/actmod.png" Width="16px" Height="16px" OnDataBinding="cmdctrl000022edit_DataBinding" CausesValidation="False" PostBackURL='<%# "frmColaboradores_det.aspx?_mode_=2&_closea_=0&param1=" & Eval("cod") & "" %>' /></ItemTemplate>
</asp:TemplateField>
...
<ItemStyle  HorizontalAlign="Left" Width="16px" />
<ItemTemplate>
<asp:ImageButton runat="server" ID="cmdctrl000022delete" ImageURL="./imagenes/actdel.png" Width="16px" Height="16px" OnDataBinding="cmdctrl000022delete_DataBinding" CausesValidation="False" PostBackURL='<%# "frmColaboradores_det.aspx?_mode_=3&_closea_=0&param1=" & Eval("cod") & "" %>' /></ItemTemplate>
</asp:TemplateField>
...
<ItemStyle  HorizontalAlign="Left" Width="16px" />
<ItemTemplate>
<asp:ImageButton runat="server" ID="cmdctrl000022copy" ImageURL="./imagenes/actcopy.png" Width="16px" Height="16px" OnDataBinding="cmdctrl000022copy_DataBinding" CausesValidation="False" PostBackURL='<%# "frmColaboradores_det.aspx?_mode_=25&_closea_=0&param1=" & Eval("cod") & "" %>' /></ItemTemplate>
</asp:TemplateField>
</Columns>
</asp:GridView>
</ContentTemplate>
</asp:UpdatePanel>
<asp:UpdateProgress  runat="server" AssociatedUpdatePanelID="updupdctrl000022" >
<ProgressTemplate><span  class="ajaxupd" ><div style="position:absolute;top:2px;left:50%; border-color:#333333; border:1; border-style:solid; background-color:#FFFFFF;padding:3px;"><image src="imagenes/ajaxupdate.gif" border=0 />Actualizando</div></span></ProgressTemplate>
</asp:UpdateProgress>

</ContentTemplate>
</asp:UpdatePanel>
<asp:UpdateProgress  runat="server" AssociatedUpdatePanelID="updupdpnlctrl000022" >
<ProgressTemplate><span  class="ajaxupd" ><div style="position:absolute;top:2px;left:50%; border-color:#333333; border:1; border-style:solid; background-color:#FFFFFF;padding:3px;"><image src="imagenes/ajaxupdate.gif" border=0 />Actualizando</div></span></ProgressTemplate>
</asp:UpdateProgress>
					<asp:SqlDataSource  runat="server" ID="dsctrl000022" ProviderName="System.Data.SqlClient" CancelSelectOnNullParameter="False" onInit="dsctrl000022_Init" SelectCommandType="Text"
 SelectCommand="SELECT EMP.cod,EMP.dsc,(EMPUNDCOD.dsc) as undcoddsc,EMP.mail,EMP.empusername,EMP.undcod FROM EMP  LEFT JOIN UND AS EMPUNDCOD ON EMPUNDCOD.cod=EMP.undcod  WHERE (((EMP.dsc LIKE '%' + @ctrl000019 + '%' OR @ctrl000019  IS NULL) AND (EMP.undcod = @ctrl000020 OR @ctrl000020 = -1) AND @qsidcod_list ) AND (EMP.baja = 0 OR EMP.baja  IS NULL)) AND EMP.cod >= 1 ORDER BY EMP.dsc,EMP.cod" onselected="dsctrl000022_Selected" onSelecting="dsctrl000022_Selecting" >
<SelectParameters>
<asp:ControlParameter  Name="ctrl000019" ControlID="ctrl000019" ConvertEmptyStringToNull="True" Direction="InputOutput" Type="String" Size="200" PropertyName="Text" />
<asp:ControlParameter  Name="ctrl000020" ControlID="ctrl000020" ConvertEmptyStringToNull="True" Direction="InputOutput" Type="Int32" PropertyName="Value" />
