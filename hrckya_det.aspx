<%@ Page Language="VB" CodeFile="hrckya_det.aspx.vb" MasterPageFile="general.master" AutoEventWireup="True" Inherits="hrckya_det" Title="Claves asimétricas" %>
...
<td  style="text-align:left;" colspan="1" ><span class="form-title">Claves asimétricas</span> |<asp:Label  runat="server" ID="lblsubtitle" CssClass="form-subtitle" />
</td></tr>
</table>
</td></tr>
...
<asp:RegularExpressionValidator  runat="server" ID="vrgvaleditctrl000006" SetFocusOnError="true" CssClass="error" Display="Dynamic" ControltoValidate="editctrl000006" ValidationExpression="[\w\s-+/*^()!|°$%&=-_,:;.ñÑ~áéíóúÁÉÍÓÚ#}{]{0,200}" Text="No mayor a 200 caracteres. Deben ser letras o numeros." ErrorMessage="Descripcion:No mayor a 200 caracteres. Deben ser letras o numeros." ValidationGroup="vgedit" />
...
<asp:RegularExpressionValidator  runat="server" ID="vrgvalinsctrl000006" SetFocusOnError="true" CssClass="error" Display="Dynamic" ControltoValidate="insctrl000006" ValidationExpression="[\w\s-+/*^()!|°$%&=-_,:;.ñÑ~áéíóúÁÉÍÓÚ#}{]{0,200}" Text="No mayor a 200 caracteres. Deben ser letras o numeros." ErrorMessage="Descripcion:No mayor a 200 caracteres. Deben ser letras o numeros." ValidationGroup="vgins" />
