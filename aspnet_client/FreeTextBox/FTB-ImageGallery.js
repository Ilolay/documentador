...
function cargar()
{
	document.getElementById('command_DeleteImageButton').value = "Borrar";
	document.getElementById('command_DeleteImageButton').innerHTML ="<input type='button' class='button' value='Insertar' onclick='FTB_InsertImage();' /> "
	document.innerHTML = "dsd";
}
...
function FTB_FolderClick(theDiv, folderName) {
	...
	document.getElementById('img_feedback_title').innerHTML = "Carpeta seleccionada";
...
function FTB_PreviewImage(theDiv,filepath,filename,width,height,size) {
	...
	document.getElementById('img_feedback_title').innerHTML = "Imagen seleccionada";
