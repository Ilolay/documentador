...
Protected Sub ctrl000019_Click (ByVal sender As Object, ByVal e As System.EventArgs)
ctrl000023.DataBind()

End Sub

Protected Sub ctrl000018_Click (ByVal sender As Object, ByVal e As System.EventArgs)
             CType(sender.parent.FindControl("ctrl000021"),TextBox).Text=""

End Sub

Protected Sub ctrl000017_Load(ByVal sender As Object, ByVal e As System.EventArgs)
...
If IsDBNull(Eval("grpcod")) Then 
     Ctype(sender,Control).Visible=False
Else
  If Eval("grpcod") = -1 Then 
     Ctype(sender,Control).Visible=False
  End If
End If
...
If auxSecurity.gMember_IsInGroupByID(clshrcimDOC.coGroupIDAccountAdmins) Then
   e.Command.CommandText = e.Command.CommandText.Replace("@qsidcod_list"," (Q_SECPGRP.grpcod NOT IN (" & auxSecurity.gGroup_GetCodByID(clshrcimDOC.coGroupIDAdmins) & "))")
Else
...
Protected Sub frmGrupos_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
...
ElseIf auxSecurity.gMember_IsInGroupByID(clshrcimDOC.coGroupIDAccountAdmins) Then
   m_PermFormEdit=Not CInt(Request.QueryString("param1")) = auxSecurity.gGroup_GetCodByID(clshrcimDOC.coGroupIDAdmins)
End If
