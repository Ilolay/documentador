...
if(this.dragNodeDestination){if(this.b21){var returnVal=this.onDragDropComplete(this.dragNodeSource,this.dragNodeDestination);if(returnVal!=null&&returnVal===false){this.dragNodeDestination=false;}}
else{var returnVal=this.onDragDropComplete(this.dragNodeSource,this.dragNodeDestination.parentNode.parentNode);if(returnVal!=null&&returnVal===false){this.dragNodeDestination=false;}}}
