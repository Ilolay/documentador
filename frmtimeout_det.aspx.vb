...
If auxEndOK Then 
     ...
     Else
         Response.Redirect("frmtimeout.aspx?_mode_=7&_closea_=0")
     End If
End If
End If
...
End Sub
Protected Sub frmtimeout_det_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
